...
import { ArrowLeft, Settings2, Type, Palette, Keyboard, Info } from 'lucide-react';
...
const sectionKeys: SettingsSection[] = ['general', 'editor', 'appearance', 'hotkeys', 'about'];
...
export function SettingsSidebar() {
  ...
  const sections: { id: SettingsSection; label: string }[] = sectionKeys.map((id) => ({
    id,
    label: t('settings.' + id),
  }));
