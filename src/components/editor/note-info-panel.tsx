...
export function NoteInfoPanel() {
  ...
  const handleExport = async (format: ExportFormat) => {
    ...
    try {
      const data = await invoke<{ content: string }>('read_note', {
  ...
  return (
    <div
      ...
      style={{ background: 'var(--notelist-bg)' }}
    >
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    pinNote(activeNote.path, checked)
                  }
                />
              </div>
              {/* Created */}
              <div className="flex items-center justify-between">
                ...
                <span className="text-[12px] text-text-secondary">
                  {formatFullDate(activeNote.created)}
                </span>
              </div>
              {/* Modified */}
              <div className="flex items-center justify-between">
                ...
                <span className="text-[12px] text-text-secondary">
                  {formatFullDate(activeNote.modified)}
                </span>
              </div>
            </div>
          </div>
